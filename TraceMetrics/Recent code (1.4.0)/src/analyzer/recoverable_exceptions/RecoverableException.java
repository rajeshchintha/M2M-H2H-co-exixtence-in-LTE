...
/**
 * 
 * General exception that does not make the execution to abort. If an exception
 * of this type is ignored, some metrics can be unreliable.
 * 
 * @since 1.0.0
 */
public class RecoverableException extends Exception {
    ...
    /**
     * Message of child exceptions
     */
    String childMessage;

    /**
     * 
     * @param childMessage message of child exception
     */
    public RecoverableException(String childMessage) {
        super("A problem was found in the trace file: "+childMessage);
