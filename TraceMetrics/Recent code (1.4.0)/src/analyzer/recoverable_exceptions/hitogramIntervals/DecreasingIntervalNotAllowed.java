...
/**
 * This exception happen when you try to set one decreasing interval when this
 * is not allowed.
 * 
 * @since 1.2.0
 */
public class DecreasingIntervalNotAllowed extends InconsistentInterval {

    public DecreasingIntervalNotAllowed() {
        super("You tried to set a decreasing range, which is not allowed.");
    }

    public DecreasingIntervalNotAllowed(String childMessage) {
        super("You tried to set a decreasing range, which is not allowed.\n" + childMessage);
    }
}
