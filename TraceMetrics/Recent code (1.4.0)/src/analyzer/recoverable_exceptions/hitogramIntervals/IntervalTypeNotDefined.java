...
/**
 * This exception happen when you try to get the type of interval when this is
 * not settled yet.
 * 
 * @since 1.2.0
 */
public class IntervalTypeNotDefined extends InconsistentInterval {

    public IntervalTypeNotDefined() {
        super("Type not yet defined.");
    }

    public IntervalTypeNotDefined(String childMessage) {
        super("Type not yet defined.\n" + childMessage);
    }
}
