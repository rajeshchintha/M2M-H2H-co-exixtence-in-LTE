...
/**
 * Abstract class for all terminals that generate a file as output.
 *
 * @since 1.2.0
 */
public abstract class FileOutputTerminal implements TerminalConfiguration {

    private final TerminalDimension defaultSize = new TerminalDimension(false);
    private TerminalDimension size = new TerminalDimension(false);
    protected double proportion = 0.0D;
