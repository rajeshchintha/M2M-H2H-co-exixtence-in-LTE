...
/**
 * Interface for padronize all tabs configurations. The responsibility to
 * implement the appropriate method for each terminal is delegated to each class
 * that implements the interface TabConfiguration.
 *
 * @since 1.2.0
 */
public interface TabConfiguration {
    ...
    /**
     * Based on selected options from terminal configuration window, build each
     * options according with selected tab options. The options are stores on
