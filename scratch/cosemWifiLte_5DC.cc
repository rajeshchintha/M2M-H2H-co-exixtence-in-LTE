 ...
 * Objective is to have more than one DC (May be 5) with set of WiFi SMs attached to each of them.
 *
...
//**************************************************************************************************
	...
	uint16_t nSmNodesDC1 = 20;//Number of SMs 
    uint16_t nSmNodesDC2 = 20;//Number of SMs 
    uint16_t nSmNodesDC3 = 20;//Number of SMs 
    uint16_t nSmNodesDC4 = 20;//Number of SMs 
    uint16_t nSmNodesDC5 = 20;//Number of SMs 
...
//COSEM Servers for DC3
  ...
  serverAppsDC3.Start (Seconds (0.1));
...
//COSEM Servers for DC4
  ...
  serverAppsDC4.Start (Seconds (0.1));
...
//COSEM Servers for DC5
  ...
  serverAppsDC5.Start (Seconds (0.1));
