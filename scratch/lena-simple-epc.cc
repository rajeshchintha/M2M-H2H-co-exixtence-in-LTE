...
**************************************************************************************************************************
Copied from https://www.nsnam.org/docs/release/3.26/models/html/lte-profiling.html#simulation-scripts   by RajeshChintha on 2Jan2017
...
main (int argc, char *argv[])
{
  ...
  uint16_t numberOfNodes = 2;//Number of eNodeBs + UE pairs
  double simTime = 1.1;
