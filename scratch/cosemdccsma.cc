...
//*********************Animation module*********************
        ...
        AnimationInterface anim("cosemdccsma.xml");// added by me
        anim.SetConstantPosition(CcCsmaNodes.Get(1),0.0,10.0);//DR node
        anim.SetConstantPosition(p2pNodes.Get(0),5.0,10.0);//MDM 
       
        anim.SetConstantPosition(AmiCsmaNodes.Get(0),5.0,5.0);//DC
        anim.SetConstantPosition(AmiCsmaNodes.Get(1),8.0,5.0);//SM1
        anim.SetConstantPosition(AmiCsmaNodes.Get(2),11.0,5.0);//SM2
        anim.SetConstantPosition(AmiCsmaNodes.Get(3),13.0,5.0);//SM3
