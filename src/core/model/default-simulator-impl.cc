  ...
  while (!m_events->IsEmpty () && !m_stop) 
    {
      ...
      ProcessOneEvent ();
 //     std:: cout << "hi i am still stuck at ln: 203 of ..../core/model/default-smulator-impl.cc " <<"\n";//added by me for debug
     // std::cout << "i=       "<< i++  <<"\n";//added by me
    }
//std:: cout << "No!!! out of ln: 203 of ..../core/model/default-smulator-impl.cc " <<"\n";//added by me for debug
